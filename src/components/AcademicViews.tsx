...
export default function AcademicViews({ subTab }: AcademicViewsProps) {
  ...
  const classSchedules = [
    ...
    {
      class: "Kelas XII (Jurusan Ilmu Agama)",
      subjects: [
        "Ushul Fiqih",
        "Ilmu Tafsir",
        "Bahasa Arab",
  ...
  return (
    ...
    >
      ...
      {subTab === "kurikulum" && (
        <div
          className="bg-white border rounded-2xl p-6 sm:p-10 shadow-sm space-y-8"
          id="academic-kurikulum"
        >
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="text-slate-600 text-sm sm:text-base leading-relaxed space-y-3 font-sans">
                <p>
                  Sesuai rujukan nasional Kementerian Keagamaan RI, MAN Kota
                  Lhokseumawe menerapkan sepenuhnya{" "}
                  <strong>Kurikulum Merdeka</strong> semenjak Tahun Pelajaran
                  2024/2025 dengan mengedepankan pembelajaran berdiferensiasi
                  serta pembentukan akhlak sosial berbasis kepemimpinan.
                </p>
                <p>
                  Unsur khas madrasah yang menjadi muatan instrumen evaluasi
                  utama kami adalah pengayaan muatan keilmuan keagamaan yang
                  terintegrasi (Integrasi Sains - Islam). Pembiasaan membaca
                  Jurnal Ilmiah, pembuatan karya tulis riset sederhana bagi
                  kelas sains, serta penulisan resensi makalah agama pada tiap
                  jenjang semester.
                </p>
              </div>
              ...
              <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-brand-gold-light rounded-xl border border-brand-gold/20 flex gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-xs p-0 text-brand-green-dark">
                      Projek Penguatan Rahmatan lil Alamin
                    </h4>
                    <p className="text-[10px] text-slate-600 mt-1">
                      Mengasah kecintaan tanah air dan pelestarian bumi melalui
                      aksi sosial terstruktur.
                    </p>
                  </div>
                </div>
                <div className="p-4 bg-brand-gold-light rounded-xl border border-brand-gold/20 flex gap-3">
              ...
              <div className="space-y-3 text-xs">
                <div className="p-3 bg-white rounded-lg shadow-xs border-l-4 border-brand-green">
                  ...
                  <p className="text-[11px] text-slate-500 font-sans">
                    Eksplorasi mata pelajaran umum secara merata tanpa peminatan
                    tertata.
                  </p>
                </div>
                <div className="p-3 bg-white rounded-lg shadow-xs border-l-4 border-brand-gold">
                  <p className="font-mono font-bold text-brand-gold-dark">
                    Fase F (Kelas XI & XII)
                  </p>
                  <p className="text-[11px] text-slate-500 font-sans">
      ...
      {subTab === "roster" && (
        <div
          className="bg-white border rounded-2xl p-6 sm:p-10 shadow-sm space-y-6"
          id="academic-roster"
        >
          <div className="text-center space-y-2">
            <span className="text-brand-gold font-mono text-xs font-bold uppercase tracking-widest font-bold">
              PEMBAGIAN MATERI
            </span>
            <h2 className="text-2xl sm:text-3xl font-display font-black text-slate-900">
              Jadwal Roster Pembelajaran Utama
            </h2>
            <div className="w-12 h-1 bg-brand-green mx-auto rounded"></div>
            <p className="text-xs text-slate-500 max-w-xl mx-auto">
              Informasi ringkasan penyaluran jam mengajar mingguan
              per-tingkatan.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
            {classSchedules.map((sched, idx) => (
              <div
                key={idx}
                className="bg-slate-50 border border-slate-205 rounded-xl p-5 hover:shadow-md transition-shadow"
              >
                ...
                <ul className="space-y-2 text-xs">
                  {sched.subjects.map((sub, i) => (
                    <li
                      key={i}
                      className="flex justify-between items-center bg-white p-2.5 rounded border border-slate-100 font-sans font-medium text-slate-700"
                    >
                      <span>{sub}</span>
                      <span className="text-[10px] text-brand-gold font-mono font-bold uppercase">
                        Wajib
                      </span>
                    </li>
                  ))}
      ...
      {subTab === "kalender" && (
        <div
          className="bg-white border rounded-2xl p-6 sm:p-10 shadow-sm space-y-6"
          id="academic-kalender"
        >
          <div className="text-center space-y-2 mb-8">
            <span className="text-brand-gold font-mono text-xs font-bold uppercase tracking-widest">
              AGENDA DIARY
            </span>
            <h2 className="text-2xl sm:text-3xl font-display font-black text-slate-900">
              Kalender Kegiatan Akademik Resmi
            </h2>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {initialCalendarEvents.map((ev) => {
              const colorMap = {
                Akademik:
                  "bg-brand-gold-light text-brand-green border-brand-gold/20",
                Libur: "bg-red-50 text-red-700 border-red-250",
                Ujian: "bg-blue-55 text-blue-700 border-blue-200",
                "Kegiatan Islami":
                  "bg-brand-gold-light text-brand-gold-dark border-brand-gold/25",
              };

              return (
                <div
                  key={ev.id}
                  className="flex gap-4 p-4 border rounded-xl hover:bg-slate-50 transition-colors"
                >
                  <div className="p-3 bg-slate-100 rounded-lg flex flex-col justify-center items-center shrink-0 w-24 border border-slate-200">
                    ...
                    <span className="text-[10px] font-mono text-slate-700 mt-0.5">
                  ...
                  <div className="flex flex-col justify-center space-y-1">
                    <span
                      className={`inline-block self-start text-[8px] font-mono font-bold px-2 py-0.5 rounded-full border ${colorMap[ev.category] || "bg-slate-100"}`}
                    >
                      {ev.category}
                    </span>
        ...
        >
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="p-6 bg-gradient-to-br from-brand-green to-slate-900 text-white rounded-2xl space-y-3 border border-brand-gold">
              <span className="bg-brand-gold text-brand-green-dark text-[9px] font-mono font-bold px-2 py-1 rounded-full uppercase">
                Pemberitahuan Resmi
              </span>
              <h3 className="text-lg sm:text-xl font-display font-bold">
                Pelaksanaan Ujian Madrasah Berbasis Digital
              </h3>
              <p className="text-xs text-slate-200 leading-relaxed font-sans">
                Seluruh rangkaian ujian Penilaian Akhir Semester (PAS/PAT) di
                MAN Kota Lhokseumawe diselenggarakan seutuhnya secara digital
                menggunakan Server Cloud CBT terenkripsi. Siswa mengakses soal
                ujian via Browser aman di perangkat handphone atau laptop
                masing-masing di madrasah tanpa kuota internet bayar.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2.5 text-xs text-slate-600">
                <li className="flex gap-2 items-start">
                  ...
                  <span>
                    Siswa wajib hadir di ruang ujian 15 menit sebelum waktu
                    pengerjaan dimulai dengan seragam identitas madrasah yang
                    rapi.
                  </span>
                </li>
                <li className="flex gap-2 items-start">
                  <div className="w-1.5 h-1.5 rounded-full bg-brand-gold mt-1.5 shrink-0"></div>
                  <span>
                    Dilarang keras menyalin materi soal, melakukan tangkapan
                    layar, berpindah tab browser, atau berinteraksi dengan siswa
                    lainnya semasa token aktif.
                  </span>
                </li>
                <li className="flex gap-2 items-start">
                  <div className="w-1.5 h-1.5 rounded-full bg-brand-gold mt-1.5 shrink-0"></div>
                  <span>
                    Kendala perangkat mati mendadak wajib dilaporkan sesegera
                    mungkin kepada Teknisi Laboratorium atau Pengawas Ruangan
                    ujian yang bertugas.
                  </span>
                </li>
              </ul>
      ...
      {subTab === "ekstra" && (
        ...
        >
              ...
              {ekskulList.map((ek) => (
                ...
                >
                  ...
                  <ChevronRight
                    size={14}
                    className={
                      activeEkskul === ek.id ? "translate-x-1 duration-200" : ""
                    }
                  />
                </button>
              ))}
          ...
          <div
            className="lg:col-span-2 bg-white border rounded-2xl overflow-hidden shadow-sm flex flex-col justify-between"
            id="ekskul-details-panel"
          >
            {ekskulList
              .filter((ek) => ek.id === activeEkskul)
              .map((ek) => (
                <div
                  key={ek.id}
                ...
                >
                  <div className="h-44 sm:h-56 relative bg-slate-100">
                    ...
                    <div className="absolute bottom-4 left-4 z-20 text-white">
                      ...
                      <h3 className="font-display font-extrabold text-lg sm:text-2xl mt-0.5">
                        {ek.name}
                      </h3>
                    </div>
                  </div>
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 border-t pt-4 text-xs">
                      <div className="bg-slate-50 p-3 rounded-lg border">
                        <p className="text-slate-400 font-bold uppercase text-[9px] tracking-wide">
                          Jadwal Latihan
                        </p>
    ...
    <div className="max-w-3xl mx-auto space-y-8" id="graduation-checker-root">
      <div className="text-center space-y-2 mb-4">
        ...
        <p className="text-xs text-slate-500 max-w-xl mx-auto mt-2">
          Masukkan NISN (Nomor Induk Siswa Nasional) atau NISM (Nomor Induk
          Siswa Madrasah) siswa kelas XII untuk mengunduh Surat Keterangan Lulus
          (SKL) digital resmi.
        </p>
      </div>
      ...
      {hasSearched &&
        (foundStudent && foundStudent.graduationStatus === "Lulus" ? (
          ...
          <div
            className="bg-white border-4 border-slate-900 p-6 sm:p-12 rounded-2xl shadow-lg relative overflow-hidden space-y-6 print:border-0 print:shadow-none print:p-0"
            id="skl-certificate-print"
          >
            ...
            <div className="text-center space-y-2 border-b-4 border-double border-slate-900 pb-5">
              <h3 className="font-display font-black text-xs uppercase tracking-widest text-slate-600">
              ...
              <p className="text-[10px] text-slate-500 font-mono">
                Jl. Mon Geudong, Banda Sakti, Kota Lhokseumawe, Aceh | NPSN:
                10103021
              </p>
            </div>
            ...
            <div className="text-center space-y-1 py-2">
              ...
              <p className="text-[10px] text-slate-400 font-mono">
                Nomor: B-431/Ma.01.21/PP.00.6/05/2026
              </p>
            </div>
            ...
            <div className="text-xs text-slate-800 space-y-4 max-w-xl mx-auto font-sans leading-relaxed">
              <p>
                Kepala Madrasah Aliyah Negeri Kota Lhokseumawe dengan ini
                menerangkan bahwa:
              </p>
              ...
              <p>
                Berdasarkan hasil Rapat Pleno Dewan Pendidik, siswa di atas
                dinyatakan:
              </p>

              <div className="text-center py-4 bg-emerald-50 border border-emerald-200 rounded-xl space-y-1">
                <span className="text-emerald-850 font-mono text-xs font-black uppercase tracking-widest block">
                  STATUS KELULUSAN
                </span>
                <span className="text-2xl sm:text-3xl font-display font-black text-brand-green uppercase tracking-wider block">
                  LULUS
                </span>
                <span className="text-[10px] text-emerald-650 font-sans block">
                  Memenuhi seluruh syarat kriteria kelulusan akademik madrasah.
                </span>
              </div>

              <p className="text-[11px] text-slate-500 italic">
                *Surat Keterangan Lulus ini sah diterbitkan secara elektronik
                sebagai acuan pendaftaran Perguruan Tinggi sementara sebelum
                Ijazah fisik dicetak oleh Kementerian Agama.
              </p>
            </div>
            ...
            <div className="pt-6 flex flex-col md:flex-row justify-between items-center text-xs text-slate-700 gap-6">
              <div className="text-center md:text-left space-y-1 font-sans">
                <p className="font-bold underline text-brand-green">
                  Verifikasi Keaslian Dokumen
                </p>
                <p className="text-[10px] text-slate-400">
                  Kode Verifikasi: VZI-2026-{foundStudent.nisn.slice(0, 4)}
                </p>
              </div>

              <div className="text-center space-y-1 w-52 font-sans">
                <p className="text-slate-500 font-mono">
                  Lhokseumawe, 31 Mei 2026
                </p>
            ...
            <div className="pt-4 border-t flex flex-col sm:flex-row gap-4 items-center justify-between text-xs print:hidden">
              <span className="text-slate-400 font-sans">
                Gunakan printer untuk mengarsip bukti fisik SKL ini secara
                resmi.
              </span>
              <button
          ...
          <div
            className="bg-slate-50 border rounded-xl p-8 text-center space-y-3.5 shadow-sm max-w-md mx-auto"
            id="graduation-failed-card"
          >
            ...
            <p className="text-xs text-slate-500 font-sans leading-relaxed">
              Keluaran status tidak ditemukan. Pastikan NISN/NISM yang Anda
              masukkan sudah terdaftar di tata usaha kelas XII (contoh
              terdaftar: 1005234231 atau 1005678121), atau silakan hubungi
              kesiswaan.
            </p>
            <button
